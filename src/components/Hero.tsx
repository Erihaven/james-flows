  ...
  return (
    <section className="relative min-h-[80vh] bg-gradient-hero overflow-hidden pt-16">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        {/* Glowing orbs */}
        <div className="absolute top-1/4 right-1/4 w-96 h-96 bg-gradient-primary opacity-20 rounded-full blur-3xl animate-float-slow"></div>
        <div className="absolute bottom-1/4 left-1/4 w-64 h-64 bg-blue-500 opacity-10 rounded-full blur-2xl animate-float-reverse"></div>
        
        {/* Floating geometric shapes */}
        <div className="absolute top-20 left-10 w-8 h-8 border border-primary/20 rotate-45 animate-float-gentle"></div>
        <div className="absolute top-40 right-20 w-6 h-6 bg-primary/10 rounded-full animate-float-gentle-reverse"></div>
        <div className="absolute bottom-32 right-32 w-4 h-4 border border-primary/15 animate-float-slow"></div>
        <div className="absolute top-60 left-1/3 w-3 h-3 bg-primary/20 rounded-full animate-float-reverse"></div>
        <div className="absolute bottom-20 left-20 w-5 h-5 border border-primary/10 rotate-12 animate-float-gentle"></div>
      </div>
